...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Publication_Date: Attribute.DateTime &
      ...
      Attribute.DefaultTo<'2024-04-08T07:00:34.559Z'>;
    home_featured: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Content_block_1: Attribute.Blocks &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Content_pictures: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
